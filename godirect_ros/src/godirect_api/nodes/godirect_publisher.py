...
def publish_grip_force():
  ...
  try:
    ...
    param_a = rospy.get_param('~param_a')
    param_b = rospy.get_param('~param_b')
    ...
    with Gdx as gdx_hd:
      ...
      gdx_hd.read(publisher=pub, measurement_type=measurement_type, param_a=param_a, param_b=param_b)
